                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span id="taxesDisplay">
                                    <fmt:formatNumber value="${flight.price * 0.05}" type="currency" currencySymbol="" maxFractionDigits="0"/> VND
                                </span>
                            </div>
                            <hr>
                            <div class="d-flex justify-content-between fw-bold">
                                ...
                                <span id="totalPriceDisplay">
                                    <fmt:formatNumber value="${flight.price * 1.05}" type="currency" currencySymbol="" maxFractionDigits="0"/> VND
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            compartmentRadios.forEach(radio => {
                radio.addEventListener('change', function () {
                    ...
                    totalPriceDisplay.textContent = Math.round(price).toLocaleString() + ' VND';
                });
            });
        });
    </script>
