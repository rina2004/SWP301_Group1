                            ...
                            <form>
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputPassword" type="password" value="${account.password}" readonly>
                                    </div>
                                </div>
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                ...
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" id="inputDob" type="text" value="${account.dob}" readonly>
                                    </div>
                                    <div class="col-md-6">
