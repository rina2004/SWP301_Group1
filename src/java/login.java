...
public class login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (acc.getRole()) {
            case "Super Admin" -> response.sendRedirect("admin.html");
            case "Manager", "Operator", "Technician", "Support" -> response.sendRedirect("staff.html");
            case "Custormer" -> response.sendRedirect("home.html");
        }
