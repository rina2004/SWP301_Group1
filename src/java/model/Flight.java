...
public class Flight {
    ...
    public Flight(String id, String name, String code, Airplane airplaneID, Location departure, Location destination, LocalDateTime entryTime, LocalDateTime startingTime, LocalDateTime landingTime) {
        this.id = id;
        this.name = name;
        this.code = code;
